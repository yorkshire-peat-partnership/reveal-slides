...
tm1 <- tmap_leaflet(tm_shape(site_peat_units) + tm_borders(col='red'))
...
# Summary statement {data-transition="slide-in fade-out"}
...
## {data-background="assets/img/site_peat_units.png"}

## Leaflet map {data-transition="slide-in fade-out"}

`r tm1`

# Erosion feature restoration
